                ...
                <c:if test="${item.ctype == 0}">
                    <li class="treeview">
                       ...
                       <i class="fa fa-angle-left pull-right"></i>
                        ...
                        <ul class="treeview-menu">
                            <c:forEach items="${modules}" var="subitem">
                                <c:if test="${subitem.ctype == 1 && subitem.parentId == item.id}">
                                    <li id="company-manager">
                                        <a href="${ctx}/${subitem.curl}" onclick="setSidebarActive(this)"  target="iframe">
                                            <i class="fa fa-circle-o"></i>${subitem.name}
                                        </a>
                                    </li>
                                </c:if>
                            </c:forEach>
